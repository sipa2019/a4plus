...
<form action="tpl_a4.php?page=<? echo $page; ?>" method=post>
	<table width="765" cellpadding="0" cellspacing="0" style="border: 1px solid #D0EC97">
		...
		<tr>
			<td width=125>&nbsp;</td>
			<td colspan=3 ><span class="textkon"><? echo $text_reg; ?></span></td>
		</tr>
		...
		<tr>
			...
			<td align="left" valign="top">
				<textarea name="rJuradr"  style="width: 95%; height: 4em">
		...
		<tr>
			...
			<td align="left" valign="top">
				<textarea name="rPieadr"  style="width: 95%; height: 4em">
		...
		<tr>
			<td colspan=2>&nbsp;</td>
			<td align="left" valign="top">
				<input type="hidden" name="action_edit" value="post">
